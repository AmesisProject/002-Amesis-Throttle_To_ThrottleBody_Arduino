...
//////////////////////////////
  ...
  //Pedale//
const int PedalePin = A2;             // Pin analogique d'enté (input) du potentiometre
...
void loop() {
 ...
 //Lecture Pédale
  ...
  PedaleValeur = map(PedaleNumerique, 507, 1023, 0, 100);         // Fonction "map" de mise à l'echelle : le 70 et 474 sont les valeur de ma pédale, il se peut que d'autre pédale et des valeur differente, pour les trouver remplacer les valeur "PedaleValeur = map(Pedale, X, Y, 0, 100);" X et Y par X = 0 et Y = 1023 et controlez votre debut/fin de course de votre pédale, vous trouvereai votre propre X et Y 
