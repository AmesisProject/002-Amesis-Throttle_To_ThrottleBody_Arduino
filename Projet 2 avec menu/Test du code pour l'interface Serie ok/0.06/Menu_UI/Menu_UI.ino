...
void afficherMenuPrincipal() { //Le menu principale comporte 14 lignes, pour garder cette resolution, il y a des Serial.prinrln ("") dans chaque menu pour compbler jusqu'a 14 Lignes, pour un affichage propre du=es menus.
  ...
  Serial.println("10) Libre III ");                                                  //11
  Serial.println("By AmesisProject Logiciel V0.06 ");                              //12
  Serial.println("......................................... ");                    //13
      ...
      Serial.println("Q) Quitter  ");
       ...
       //1.6.1.2
             ...
             while (niveauMenu == MENU_LOG_Capteur_Cruise) {
              Serial.print("Bouton On/Off = ");  Serial.print(CruiseButton_ActiveCruise); 
              Serial.print(" | BP Up = ");       Serial.print(Cruise_Up); 
              Serial.print(" | BP Down = ");     Serial.print(Cruise_Down);
              Serial.print(" | BP Cancel = ");   Serial.print(Cruise_Cancel); 
              Serial.print(" |     "); 
              Serial.println("Q) Quitter  ");
