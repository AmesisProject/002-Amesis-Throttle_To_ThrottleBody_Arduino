...
extern int TPSMotorMode;
extern int ModeDegradeEtat;
extern int Cruise_TargetKmH;

extern int PwmDutyMini;
extern int PwmDutyMaxi;
...
#define MENU_DSG                      "1.6.3"  //    1.6.3
#define MENU_DSG_Mode                 "1.6.3.1"//        1.6.3.1
#define MENU_DSG_Duree                "1.6.3.2"//        1.6.3.2
#define MENU_RESEAU_CAN               "1.6.4"  //    1.6.4
#define MENU_ACQ_EEPROM               "1.6.5"  //    1.6.5
...
/**
 * @brief Gère les réglages DSG du menu 1.6.3
 * @param option L'option sélectionnée par l'utilisateur
 */
void handleDSGMenu(String option);

/**
 * @brief Gère les commandes EEPROM du menu Acquisition (1.6.5)
 * @param option L'option sélectionnée par l'utilisateur
 */
