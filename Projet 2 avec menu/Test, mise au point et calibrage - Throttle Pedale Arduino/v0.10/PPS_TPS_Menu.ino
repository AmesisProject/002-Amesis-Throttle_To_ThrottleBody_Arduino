...
void afficherSousMenu(String menu) {
  ...
  //!1.2   
    ...
    //!1.2.2
         ...
         while (niveauMenu == MENU_TPS_Calibration) {
           //Appele de la routine PPS_Calibration();
        //  TPS_Calibration();
          Serial.print("Do not touch the pedal ! ");
          Serial.print("TPS1 = " + String(TPSPot1_ADC) + "ADC / " + String(TPS1_Position) + "% |  | "); 
          Serial.print("TPS2 = " + String(TPSPot2_ADC) + "ADC / " + String(TPS2_Position) + "% |  | "); 
          Serial.println("Q) Quit");
  ...
  //!1.3 
    ...
    Serial.println("1) PWM Min (Current value : " + String(PwmMini) + ") ");
    Serial.println("2) PWM Max (Current value : " + String(PwmMaxi) + ") ");
    Serial.println("");
  ...
  //!1.4 
    ...
    Serial.println("1) Hz (Current value : " + String(TPSFreq) + ") ");
    Serial.println("");
...
//!1.3.1 (Depuis le rajopur ici de 1.3.1 et 1.3.2 il y a un bug dans tous les 1er sous menu, il faut fait "q" 2 fois pour quitter)
           if (niveauMenu == MENU_REGLAGE_PWM) {
              if (option == "1") {
                 ...
                 Serial.println("Current value : " + String(PwmMini));
                 Serial.println("");
                 Serial.println("");
                 Serial.println("");
                 Serial.println("");
               ...
               //!1.3.2 (Depuis le rajopur ici de 1.3.1 et 1.3.2 il y a un bug dans tous les 1er sous menu, il faut fait "q" 2 fois pour quitter)
                 ...
                 Serial.println("Current value : " + String(PwmMaxi));
                 Serial.println("");
                 Serial.println("");
                 Serial.println("");
                 Serial.println("");
           ...
           if (niveauMenu == MENU_REGLAGE_FREQUENCE) {
              if (option == "1") {
                 Serial.println("\n//" + niveauMenu + " New Hz// ");
                 Serial.println("Current value : " + String(TPSFreq));
                 Serial.println("");
                 Serial.println("");
                 Serial.println("");
                 Serial.println("");
...
//!1.5.1.1 
           if (niveauMenu == MENU_PID_Normal) {
              if (option == "1") {
                 ...
                 Serial.println("Current value : " + String(kP));
                 Serial.println("");
                 Serial.println("");
                 Serial.println("");
                 Serial.println("");
             ...
             //!1.5.1.2  
                 ...
                 Serial.println("Current value : " + String(kI));
                 Serial.println("");
                 Serial.println("");
                 Serial.println("");
                 Serial.println("");
              ...
              //1.5.1.3
                 ...
                 Serial.println("Current value : " + String(kD));
                 Serial.println("");
                 Serial.println("");
                 Serial.println("");
                 Serial.println("");
...
//!1.5.2.1 
           if (niveauMenu == MENU_PID_Agressif) {
              if (option == "1") {
                 ...
                 Serial.println("Current value : " + String(kP_Agressif));
                 Serial.println("");
                 Serial.println("");
                 Serial.println("");
                 Serial.println("");
             ...
             //!1.5.2.2  
                 ...
                 Serial.println("Current value : " + String(kI_Agressif));
                 Serial.println("");
                 Serial.println("");
                 Serial.println("");
                 Serial.println("");
              ...
              //1.5.2.3
                 ...
                 Serial.println("Current value : " + String(kD_Agressif));
                 Serial.println("");
                 Serial.println("");
                 Serial.println("");
                 Serial.println("");
